...
- Botón de modo oscuro y claro manual con html[data-theme]: usamos un atributo en el <html> para indicar el tema activo, con las variables en css definimos los colores y estilos según el tema.
Usamos js para el uso del botón, permitiendo "forzar" manualmente el cambio de aspecto .

El @media (prefers-color-scheme: dark) detecta la preferencia de color del sistema operativo del usuario, aplicando automáticamente el css en modo oscuro.
